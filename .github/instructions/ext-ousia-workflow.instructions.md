...
- 如果 `README.md`、`.ousia/**/*.md`、`.github/instructions/**/*.instructions.md` 或 `.github/skills/**/SKILL.md` 改动，检查 Markdown 链接、YAML frontmatter、description 和 stale path。
...
- 如果当前 profile 提供 documentation config，再运行 `deno task --cwd .github/skills/doc-validation check:docs --config <profile-doc-config>`。本仓库当前 manifest 没有配置 repo-local doc config 时，不运行 legacy project docs check。
