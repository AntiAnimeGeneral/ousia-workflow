...
Deno.test("reinstall overwrites changed Ousia-owned baseline file", async () => {
...
Deno.test("source snapshot excludes local override files from install payload", async () => {
...
Deno.test("planner follows manifest upgrade policy instead of ownership name", async () => {
...
Deno.test("apply preflight failure leaves planned files unchanged", async () => {
...
Deno.test("apply rollback restores replaced file after commit failure", async () => {
...
Deno.test("upgrade overwrites Ousia-owned file modified after last install", async () => {
...
Deno.test("source snapshot keeps support files and excludes repository policy", async () => {
